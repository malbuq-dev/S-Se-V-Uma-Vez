...
from dataset import LiaDataset
from utils import (
    non_max_suppression,
...
def main():
    ...
    train_dataset = LiaDataset(
        "dataset/375examples.csv",
        transform=transform,
        img_dir=IMG_DIR,
        label_dir=LABEL_DIR,
        C=1
    ...
    test_dataset = LiaDataset(
        "dataset/test.csv", transform=transform, img_dir=IMG_DIR, label_dir=LABEL_DIR, C=1
    )
